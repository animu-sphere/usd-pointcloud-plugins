...
- Derivation: select exactly 4096 points at deterministic, evenly spaced indices
  ...
  sibling LAZ asset uses the same selected points.
- Output: `usgs-3dep-2020-thinned-4096.las`, 4096 points, LAS 1.2 point format 3
- Output SHA-256: `23b755c51141e6b617a0dcc89473ec31117b54b87364d7e3c72a3ef69de78e53`
- Regeneration: read the source LAZ with `laspy` in 1,000,000-point chunks,
  ...
  the supported fields into a LAS 1.2 point format 3 header, and write LAS.