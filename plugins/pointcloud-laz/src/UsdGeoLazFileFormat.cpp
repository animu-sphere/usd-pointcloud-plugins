...
const TfToken DynamicLodField("pc_laz_lod");
...
void UsdGeoLazFileFormat::ComposeFieldsForFileFormatArguments(
    const std::string&,
...
bool UsdGeoLazFileFormat::CanFieldChangeAffectFileFormatArguments(
    const TfToken& field,
    const VtValue&,
    const VtValue&,
    const VtValue&) const {
