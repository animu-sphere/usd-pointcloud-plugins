...
#define USDGEOPLY_FILE_FORMAT_TOKENS \
    ((Id, "ply")) \
    ((Version, "1.0")) \
    ((Target, "usd")) \
    ((Extension, "ply"))

TF_DECLARE_PUBLIC_TOKENS(UsdGeoPlyFileFormatTokens, USDGEOPLY_FILE_FORMAT_TOKENS);

class UsdGeoPlyFileFormat final : public SdfFileFormat,
