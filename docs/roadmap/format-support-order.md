...
| 4 | Measurement and I/O observability | `v0.8.0` | Fixed-grid and adaptive are compared on uneven real data, and source, spool, and payload I/O are visible in benchmark output; released |
| 5 | TilePlan convergence and interactive validation | `v0.9.0` | Released: sequential planning and COPC native hierarchy reach payload authoring through one plan representation, with a reproducible host-responsiveness baseline |
